...
//        }
    ...
    private static void Init(CommandOpMode mode) {
        ...
        frontTouchTrigger = new Trigger(() -> SimpleRobotContainer.frontTouch.hasTouched());

        // should button used to reset position
        shoulderPositionTrigger = new Trigger(()-> SimpleRobotContainer.shoulderJoint.getShoulderButton());
    ...
    public static void setOdometry(Odometry odometry) {
        SimpleRobotContainer.odometry = odometry;
    }
