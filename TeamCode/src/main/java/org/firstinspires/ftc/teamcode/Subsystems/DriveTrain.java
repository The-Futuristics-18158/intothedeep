...
public class DriveTrain extends SubsystemBase {
    ...
    public void RobotDrive(double Vx, double Vy, double Omega, double powerFactor) {
        ...
        double CurrentLeftFrontRPM = MPStoRPM * leftFrontDrive.getVelocity();
        double CurrentRightFrontRPM = MPStoRPM * rightFrontDrive.getVelocity();
        double CurrentLeftBackRPM = MPStoRPM * leftBackDrive.getVelocity();
    ...
    private class MotorControl {
        ...
        private double Pgain = 0.75 * 0.00016667;
        private double Igain = 0.30 * 0.00016667;
        private double Fgain = 0.90 * 0.00016667;  // use 90% to assume battery voltage typ. at 13V and not 12.
