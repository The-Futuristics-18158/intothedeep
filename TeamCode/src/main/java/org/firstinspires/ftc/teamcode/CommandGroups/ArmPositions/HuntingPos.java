...
public class HuntingPos extends SequentialCommandGroup {
    ...
    public HuntingPos() {
        addCommands(
                ...
                new InstantCommand(() -> RobotContainer.shoulderJoint.RotateTo(95+19.5)),
                ...
                new InstantCommand(() ->RobotContainer.elbowJoint.RotateTo(150 + RobotContainer.elbowJoint.elbowServoOffset)),
