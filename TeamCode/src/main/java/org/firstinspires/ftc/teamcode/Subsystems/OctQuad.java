...
public class OctQuad extends SubsystemBase {
    ...
    public OctQuad() {
        ...
        octoquad.setSingleEncoderDirection(0, OctoQuadBase.EncoderDirection.FORWARD); //.REVERSE);
        octoquad.setSingleEncoderDirection(1, OctoQuadBase.EncoderDirection.REVERSE); //.FORWARD);
